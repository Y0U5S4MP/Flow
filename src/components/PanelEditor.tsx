...
import {
  ...
  Trash2, Eye, EyeOff, ArrowUp, ArrowDown, Crop, Save, Copy
} from 'lucide-react';
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-80 border-l border-gray-200 flex flex-col bg-white">
            <div className="flex border-b border-gray-200">
              ...
              ] as { key: 'elements' | 'animations' | 'canvas'; label: string }[]).map(({ key, label }) => (
                <button
                  key={key}
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            const animation: ElementAnimation | undefined = e.target.value === 'none'
                              ? undefined
                              : {
                                  type: e.target.value as ElementAnimation['type'],
