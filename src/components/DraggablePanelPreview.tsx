...
import { FileText, Image, Film, Upload as UploadIcon, CreditCard as Edit, Trash2, Eye, EyeOff, Copy, Move3d as Move3D, Zap, Music, Sparkles, ArrowUp, ArrowDown, ArrowRightLeft } from 'lucide-react';
